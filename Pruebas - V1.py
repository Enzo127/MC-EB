...
game.board = [
            [' ', ' ', 'h', 'h', 'b', 'b', 'q', 'q', 'k', 'k', 'b', 'b', 'h', 'h', ' ', ' '],
            [' ', 'r', 'h', 'h', 'b', 'b', 'q', 'q', 'k', 'k', 'b', ' ', 'H', 'h', ' ', ' '],
            ...
            [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
            [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
            ['P', 'R', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'k', 'P', 'P', 'P', 'P', 'q', 'P'],
            ['P', 'P', 'P', ' ', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P'],
            [' ', 'r', 'K', 'H', 'B', 'B', 'Q', 'Q', 'K', 'K', 'B', 'B', 'H', 'H', ' ', ' '],
            [' ', ' ', 'K', 'H', 'B', 'B', 'Q', 'Q', 'K', 'K', 'B', 'B', 'H', 'H', ' ', ' ']]
...
print(moves_enemy[2][0])
print(len(moves_enemy[2][0]))
print(moves_enemy[2][1])
print(len(moves_enemy[2][1]))